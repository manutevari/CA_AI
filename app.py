...
**Local preview URLs** (after you start each stack on your machine):

- **Streamlit (this UI):** [http://localhost:8501](http://localhost:8501) — run `streamlit run app.py` from the repo root  
- **Next.js (Docker / dev):** [http://localhost:3000](http://localhost:3000)  
- **FastAPI docs:** [http://localhost:8000/docs](http://localhost:8000/docs)  

**Hosted preview:** deploy Streamlit on [Streamlit Community Cloud](https://share.streamlit.io) (main file `app.py`); your app URL appears in the Cloud dashboard (e.g. `https://<name>.streamlit.app`).
        """
    )
